...
| aggregate | `term_frequency`, `keyword_frequency` (deprecated alias), `noun_frequency`, `time_bucket_count`, `meta_group_count`, `dictionary_tagging` |
| retrieve | `embedding_cluster`, `cluster_label_candidates`, `semantic_search` |
| summarize | `issue_evidence_summary`, `evidence_pack` (deprecated alias), `unstructured_issue_summary`, `issue_breakdown_summary`, `issue_cluster_summary`, `issue_trend_summary`, `issue_period_compare`, `issue_sentiment_summary`, `issue_taxonomy_summary` |
