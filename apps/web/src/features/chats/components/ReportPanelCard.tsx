    ...
    >
      ...
      <div className="group flex items-start gap-1.5">
        <EditableText
          ...
          ariaLabel="카드 제목"
          className="min-w-0 flex-1 cursor-text rounded-md py-0.5 text-[13.5px] font-bold leading-snug text-zinc-900 hover:bg-zinc-100 focus:bg-white focus:ring-2 focus:ring-violet-200"
        />
