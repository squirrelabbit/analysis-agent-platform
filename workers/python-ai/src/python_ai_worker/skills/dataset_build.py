            ...
            embedding_index_rows.append(
                {
                    ...
                    "embedding_json": json.dumps(list(dense_vectors[chunk_index]), ensure_ascii=False) if dense_vectors else "",
                    "embedding_dim": embedding_vector_dim if dense_vectors else 0,
                    "embedding_provider": embedding_provider if dense_vectors else "",
